...
- (void)viewDidLoad {
    ...
    UIImage * iamge = [LFDRQDealManger generateIamgeWithString:@"http://www.jianshu.com/p/e8f7a257b612" size:imageView.bounds.size icon:[UIImage imageNamed:@"appIcon"] iconSize:CGSizeMake(60, 60)];
