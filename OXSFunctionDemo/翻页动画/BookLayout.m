...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSInteger curretPage = self.collectionView.contentOffset.x/ pageWidth;
    ...
    NSLog(@"curretPage = %ld , indexPath.item = %ld",curretPage,indexPath.item);
    //计算旋转角度angle,设定3D旋转
...
//        NSLog(@"中心线在右边 angle= %lf,intm = %ld ",angle,indexPath.item);
