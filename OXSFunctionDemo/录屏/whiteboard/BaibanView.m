...
-(void)addHeadBar{
    headView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, 44)];
    headView.backgroundColor = [UIColor whiteColor];
    [self addSubview:headView];

    
    self.btnSelectColor1 = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, headView.frame.size.width/2-1, 44)];
    ...
    self.btnSelectColor2 = [[UIButton alloc] initWithFrame:CGRectMake(headView.frame.size.width/2, 0, headView.frame.size.width/2, 44)];
...
-(void)addBottomBar{
    ...
    //添加操作栏，偷懒就不封装了
    bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height-49, self.frame.size.width, 49)];
    bottomView.backgroundColor = [UIColor blackColor];
    [self addSubview:bottomView];
    
    CGFloat btnW = self.frame.size.width/4;
    UIButton *btnPreviewAction = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, btnW, bottomView.frame.size.height)];
    ...
    UIButton *btnCleanAll = [[UIButton alloc] initWithFrame:CGRectMake(btnW, 0, btnW, bottomView.frame.size.height)];
    ...
    UIButton *btnXPC = [[UIButton alloc] initWithFrame:CGRectMake(btnW*2, 0, btnW, bottomView.frame.size.height)];
    ...
    UIButton *btnSave = [[UIButton alloc] initWithFrame:CGRectMake(btnW *3, 0, btnW, bottomView.frame.size.height)];
...
//    self.selectColorView.frame = CGRectMake(0, 0, self.frame.size.width, 0);
//    [UIView animateWithDuration:0.3 animations:^{
//        self.selectColorView.frame = CGRectMake(0, 0, self.frame.size.width, self.frame.size.width);
//    }];
    if (!_screenRecorder) {
        _screenRecorder = [[ScreenRecorder alloc]init];
    }
    [_screenRecorder readyGo:self];
    [_screenRecorder startRecord:[self tempFilePath]];
...
- (void)selectColor2 {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.selectColorEasyView.frame = CGRectMake(0, 0, self.frame.size.width, 44);
    }];
