...
@implementation ShowMessageButton
...
- (void)updateCCPCountDownButtonTitle
{
    if (self.tempDurationOfCountDown == 0)
    {
        ...
        [self setTitle:[NSString stringWithFormat:@"%zd秒重新获取", self.tempDurationOfCountDown--] forState:UIControlStateNormal];
